...
namespace KDE
{
	KDTexture::KDTexture(KDE::KDGraphics& gfx, const KDSurface& surface)
	{
		INFOMAN(gfx);
	...
	KDTexture::KDTexture(KDE::KDGraphics& gfx, const std::string& filePath)
	{
		KDSurface surface = KDSurface::FromFile(filePath);

		KDTexture(gfx, surface);
	}

	void KDTexture::Bind(KDGraphics& gfx)
	{
